...
internal sealed class UpdateTransmissionTransmissionContentDtoValidator : AbstractValidator<TransmissionContentDto>
{
    ...
    public UpdateTransmissionTransmissionContentDtoValidator(IUser? user)
    {
