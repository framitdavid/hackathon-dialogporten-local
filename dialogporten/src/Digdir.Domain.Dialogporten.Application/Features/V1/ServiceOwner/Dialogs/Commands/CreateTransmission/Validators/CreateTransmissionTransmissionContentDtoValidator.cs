...
internal sealed class CreateTransmissionTransmissionContentDtoValidator : AbstractValidator<TransmissionContentDto>
{
    ...
    public CreateTransmissionTransmissionContentDtoValidator(IUser? user)
    {
